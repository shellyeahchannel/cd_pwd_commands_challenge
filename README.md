...
• Download the zip file cd_pwd_challenge.zip and extract the contents on a seperate folder under /tmp on your PC.
mkdir /tmp/challenge

mv cd_pwd_challenge.zip /tmp/challenge

cd /tmp/challenge

unzip cd_pwd_challenge.zip

• The zip file is password-protected, and the passphrase is revealed in a pop-up message during the video https://youtu.be/cUXARADwfLo
